...
ActiveRecord::Schema[7.2].define(version: 2026_06_21_000002) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "include_in_stats", default: false, null: false
  ...
  create_table "quotes", force: :cascade do |t|
    ...
    t.index ["date"], name: "index_quotes_on_date"
  ...
  create_table "stock_movements", force: :cascade do |t|
    ...
    t.index ["quote_id"], name: "index_stock_movements_on_quote_id"
  ...
  add_foreign_key "stock_movements", "quotes", on_delete: :nullify
